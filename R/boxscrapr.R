    ...
    tryCatch({
      ...
      for(game in 1:NumGames){
        ...
        tryCatch({
            ...
            click = rvest::follow_link(Session, "Final")
            ...
            box.scrape.text = html_text(html_nodes(read_html('https://www.sports-reference.com/cbb/boxscores/2019-04-08-21-virginia.html'), xpath='//*[contains(concat( " ", @class, " " ), concat( " ", "right", " " ))] | //*[contains(concat( " ", @class, " " ), concat( " ", "left", " " ))]'))

            HomeBoxScoreRaw = box.scrape.text[489:510]
            ...
            AwayBoxScoreRaw = box.scrape.text[236:257]
