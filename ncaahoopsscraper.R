...
#'
#' Takes inputs for beginning and end of season and scrapes www.sports-reference.com
#' for all scores between those dates (inclusive).
#'
#' @author Kurt Wirth
#'
#' @param StartDate The beginning date of data scraping, in the format
#' "yyyy/mm/dd".
#' 
#' @param EndDate The ending date of data scraping, in the format
#' "yyyy/mm/dd".
#'
